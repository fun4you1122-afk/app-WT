...
const SERVICES = [
  {
    ...
    description: 'Build intelligent systems with custom ML models, NLP, computer vision, and predictive analytics tailored for enterprise.',
  ...
  },
  {
    ...
    description: 'Design and deploy scalable, resilient cloud infrastructure on AWS, Azure, and Google Cloud with zero-downtime deployments.',
  ...
  },
  {
    ...
    description: 'Protect your digital assets with advanced threat detection, penetration testing, and compliance frameworks for UAE regulations.',
    tags: ['Threat Detection', 'Compliance', 'Zero Trust'],
  ...
  },
  {
    ...
    description: 'Create next-generation mobile and web applications with cutting-edge UX, AI integration, and enterprise-grade performance.',
  ...
  },
  {
    ...
    description: 'Transform raw data into actionable insights with real-time dashboards, BI reporting, and AI-powered forecasting engines.',
    tags: ['BI', 'Real-time', 'Forecasting'],
  ...
  },
  {
    ...
    description: 'End-to-end digital transformation programs that modernize legacy systems and accelerate innovation across your enterprise.',
      ...
      <ScrollView style={styles.scroll} contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.title}>
            Our <Text style={{ color: Colors.neonBlue }}>Services</Text>
          </Text>
          <Text style={styles.description}>
            Cutting-edge technology solutions built for the modern UAE enterprise landscape.
          </Text>
        </View>
        ...
        <TouchableOpacity activeOpacity={0.9} style={{ marginBottom: Spacing.lg }}>
          <LinearGradient
            colors={['rgba(0,212,255,0.2)', 'rgba(0,102,255,0.15)', 'rgba(191,95,255,0.1)']}
          ...
          >
            ...
            <View style={styles.featuredContent}>
              ...
              <Text style={styles.featuredDesc}>
                Our flagship AI platform — combining ML, NLP, and analytics in one powerful enterprise solution.
              </Text>
        ...
        <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.filters} contentContainerStyle={{ gap: 8, paddingRight: 16 }}>
          {FILTERS.map((f) => (
            <TouchableOpacity
              ...
              style={[
                styles.filterBtn,
                activeFilter === f && { backgroundColor: `${Colors.neonBlue}20`, borderColor: `${Colors.neonBlue}50` },
              ]}
            >
